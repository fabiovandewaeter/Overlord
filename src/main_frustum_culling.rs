...
const GRID_SIZE_SQUARE: TilemapGridSize = TilemapGridSize { x: 34.0, y: 34.0 };
...
impl FromWorld for TextureHandles {
    fn from_world(world: &mut World) -> Self {
        ...
        Self {
            hex_row: asset_server.load("img/tiles/grass_0.png"),
            hex_col: asset_server.load("img/tiles/grass_0.png"),
            square: asset_server.load("img/tiles/grass_0.png"),
            iso: asset_server.load("img/tiles/grass_0.png"),
        }
    }
}
